...
<details>
  ...
  // REDIRECT URL must be same with URL where the (reactjs-shubham) components is locate
  // MAKE SURE the (reactjs-shubham) components aren't unmounted or destroyed before the ask permission dialog closes
